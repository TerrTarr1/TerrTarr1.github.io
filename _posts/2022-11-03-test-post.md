...
하이퍼링크
-----------
단어 안에 하이퍼링크 담아주고싶으면 `[문장에 들어가는 단어 적기](하이퍼링크 주소 적기)` 이 형식대로 적기, 저위에 github 링크도 이런식으로 만듬.
...
팁이나 위험경고 강조하기
------------
**notice--danger** : 빨간 칸으로 강조할수있음.
{: .notice--danger}

**notice--info** : 파란칸으로 채워짐. 
{:.notice--info}
```
제목 : 내용       //제목과 내용은 다 적고, 아래 내려와서 중괄호 치고, :를 넣고, .notice--info 이나 .notice--danger 넣고 괄호 닫는다.
{: .notice--info}
```
